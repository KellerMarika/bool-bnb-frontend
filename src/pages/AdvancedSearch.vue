    ...
    <form @submit.prevent="fetchTomTom">
      <div class="d-flex align-items-center justify-content-around gap-4 p-5">
        <div class="input-container mb-2 col-3 ">
          ...
          <input type="text" placeholder="Ex. Via generale cascino 14 Roma" class="form-control" id="streetNameInput" v-model="address"/> 
        </div>
...
export default {
  ...
  methods: {
    ...
    fetchTomTom() {
      axios.get(this.baseUrl + this.address + this.api_key)
        .then((resp) => {
